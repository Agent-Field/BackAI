...
mirrored by the runtime. Search for `PluginSchema` / `PluginListSchema`.
...
([`apps/dashboard/src/lib/plugins.ts`](../apps/dashboard/src/lib/plugins.ts))
...
[`apps/dashboard/scripts/generate-plugins-manifest.mjs`](../apps/dashboard/scripts/generate-plugins-manifest.mjs)
runs as the `predev` and `prebuild` script (see
...
2. Writes
   [`apps/dashboard/src/lib/plugins.generated.ts`](../apps/dashboard/src/lib/plugins.generated.ts)
   — a module that re-exports the imported `PluginDefinition` array.
...
implementation
([`services/runtime/internal/server/plugins.go`](../services/runtime/internal/server/plugins.go))
