    ...
    items: [
      {
        ...
        archetype: "topology",
        dataTruth: "degraded",
        apiGap: "Universal admin adapter introspection endpoint is pending.",
      },
      {
      ...
      },
      {
        ...
        icon: "spark",
        description: "Gateway models, provider key health, and adapter link-out.",
        archetype: "config-inventory",
        dataTruth: "degraded",
      ...
      },
      {
        ...
        icon: "activity",
        description: "Metrics, logs, traces, exporters, and link-outs.",
        archetype: "config-inventory",
        dataTruth: "derived",
      ...
      },
      {
        ...
        icon: "globe",
        description: "Informational deploy target status and provider link-outs.",
        archetype: "config-inventory",
        dataTruth: "missing",
