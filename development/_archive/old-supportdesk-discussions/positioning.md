...
These three terms recur in this doc and in `development/strategy.md`. They're easy
...
#### A3. The 11 completeness features (from docs/extensibility.md)
...
- The 8-band stack architecture (docs/stack.md)
...
- [x] Merge `PLAN-NEXT.md` + `PLAN-CLEAN.md` → `development/strategy.md`
...
- [x] Create `docs/stack.md` (Supabase-shaped 8-band layered diagram)
- [x] Create `development/positioning.md` (this doc)
- [x] Refresh `docs/architecture.md` (point at `docs/stack.md` for diagram)
- [x] Refresh `docs/oss-audit.md` (item statuses updated)
...
- [x] Update `development/operator-console-inventory.md` to reflect the new IA
...
- [x] Link to `docs/stack.md` for architecture, `development/positioning.md` for
      strategy
...
The 11 features from `docs/extensibility.md` that take us from "Phase 16
...
Already specified in `development/strategy.md`. Re-listed here for one ordered
view.
...
- [x] **AgentField data in dashboard** — inline run summary + control
      ...
      `development/strategy.md` / `docs/agentfield-integration.md` (~1 week)
