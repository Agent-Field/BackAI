...
1. **Reference, don't duplicate.** Where canonical info already lives in
   the repo (docs/stack.md, development/positioning.md, development/strategy.md, OpenAPI), the skill
...
|---|---|---|
| 1. What AF Stack is | One paragraph; links to development/positioning.md | 5 lines |
...
| 4. The 8 layered bands | Reference link to docs/stack.md; list the bands | 10 lines |
...
For positioning: development/positioning.md
For layered architecture: docs/stack.md
For strategy + ownership boundary: development/strategy.md
```
...
```markdown
See docs/stack.md for the layered architecture.
...
10. **The repo IS the product.** No "managed offering" code paths, no
    ...
    SaaS we run. See development/positioning.md.
```
...
development/positioning.md and development/strategy.md in this repo: source of truth lives with
the code.
