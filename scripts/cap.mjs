...
await p.screenshot({ path: "docs/assets/dashboard-screenshots/audit-after.png", fullPage: false })
...
await p.screenshot({ path: "docs/assets/dashboard-screenshots/audit-datepicker.png", fullPage: false })
await b.close()
