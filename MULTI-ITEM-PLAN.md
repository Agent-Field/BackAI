...
- Update `STRATEGY.md` Phase 2 / EXTENSIBILITY.md §4.2 #7 → ✅
- Update `skills/af-stack/SKILL.md` primitives table — Multimodal from "Yet to ship" → Tier 1 ✅
- Update `MULTI-ITEM-PLAN.md` #14 status → ✅
- Add `docs/multimodal.md` with provider matrix + how to add a new adapter
- Update `OSS-AUDIT.md` — add ElevenLabs / Cartesia / Flux / fal as vendored choices
...
`ARCHITECTURE.md`'s "don't rebuild what's already excellent" rule, we
...
- `docs/realtime-runs.md` (new), `EXTENSIBILITY.md`, `skills/af-stack/SKILL.md`
...
- Update `STRATEGY.md` Tier 1 #1 — note that the in-memory limiter is removed
- Update `OSS-AUDIT.md` — note that rate limiting is now upstream (LiteLLM owns it)
- Update `skills/af-stack/rules/sdk.md` — note 429 responses now carry full rate-limit headers
- Update `MULTI-ITEM-PLAN.md` #32 status → ✅
